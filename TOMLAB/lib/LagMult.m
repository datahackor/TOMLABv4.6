...
% cErr        Error in nonlinear constraints
...
% Copyright (c) 1999-2004 by Tomlab Optimization Inc., Sweden. $Release: 4.2.2$
% Written Dec 8, 1998.      Last modified Mar 31, 2004.
%
...
%disp(b_L Ax  b_U])
%disp(' ')
%disp([Result.Prob.x_L x_k Result.Prob.x_U])
%disp([Result.Prob.b_L Result.Prob.A*x_k  Result.Prob.b_U])

% PrintMat prints matrix with labels and tries to be intelligent
%
% function printmat(A,Name,MaxCols,ColScr,RowLab,ColLab)
%
% A       Matrix
...
% Copyright (c) 1998-2004 by Tomlab Optimization Inc., $Release: 4.2.0$
% Written Aug 11, 1997.   Last modified Dec 16, 2003.
%
...
if m==0 | nc==0   % Empty matrix case
   % Empty matrix
   fprintf('printmat: Empty Matrix ');
   if exist('Name'),fprintf('%s',Name); end 
   fprintf('\n\n');
   return
end

...
%
% sim_gdc calls the routine Prob.USER.gdc (if nonempty)
% either as [g,dc]=feval(Prob.USER.g, x) or
%           [g,dc]=feval(Prob.USER.g, x, Prob,varargin)
...
% Written May 24, 2003.   Last modified Apr 13, 2004.
%

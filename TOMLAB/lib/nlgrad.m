%		nlgrad.m
%
% function [df, dg]=nlgrad(x, Prob)
%
% nlgrad calls the TOMLAB gateway functions nlp_g and nlp_dc, 
% to evaluate the gradient of the objective and constraint function.
%
...
%  g(x) >= 0  (linear constraints first, then nonlinear)
%
% nlgrad is used as callback from Schittkowski routines
%
% Kenneth Holmstrom, Tomlab Optimization Inc., E-mail: hkh@tomlab.biz.
% Copyright (c) 2003 by Tomlab Optimization Inc., Sweden. $Release: 4.0.6$
% Written April 27, 2003.   Last modified April 27, 2003.
%

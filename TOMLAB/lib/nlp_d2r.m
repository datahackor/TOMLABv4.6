...
%
% nlp_d2r calls the routine Prob.USER.d2r either as 
%           d2r=feval(Prob.USER.d2r, x ) or
%           d2r=feval(Prob.USER.d2r, x, r) or
%           d2r=feval(Prob.USER.d2r, x, r, J) or
%           d2c=feval(Prob.USER.d2r, x, r, J, Prob, varargin{:})
% depending on the number of inputs in Prob.USER.d2r
%
...
% Written Oct 23, 1998.  Last modified Jan 21, 2005.
%
...
elseif isempty(Prob.USER.d2r)
   ...
   n_d2r=n_d2r+1; 
   p=xnargin(Prob.USER.d2r);
   if p>4
      d2r=feval(Prob.USER.d2r, x(1:N), r, J, Prob, varargin{:});
   elseif p==4
      d2r=feval(Prob.USER.d2r, x(1:N), r, J, Prob);
   elseif p==3
      d2r=feval(Prob.USER.d2r, x(1:N), r, J); 
   elseif p==2
      d2r=feval(Prob.USER.d2r, x(1:N), r); 
   elseif p==1
      d2r=feval(Prob.USER.d2r, x(1:N)); 
   else
      d2r=[];
   end
end

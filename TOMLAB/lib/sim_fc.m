...
%
% sim_fc calls the routine Prob.USER.fc
% either as [f,c]=feval(Prob.USER.fc, x) or
%           [f,c]=feval(Prob.USER.fc, x, Prob or
%           [f,c]=feval(Prob.USER.fc, x, Prob,varargin)
% depending on the number of inputs
%
% The global counters n_f and n_c are incremented
%
% Kenneth Holmstrom, Tomlab Optimization Inc, E-mail: hkh@tomlab.biz
% Copyright (c) 2003-2004 by Tomlab Optimization Inc., $Release: 4.3.0$
% Written May 24, 2003.   Last modified May 6, 2005.
%

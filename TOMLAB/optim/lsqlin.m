% lsqlin is the TOMLAB equivalent to LSQLIN in Optimization TB 2.x
%
...
%
%          The fields used are (see the help of llsAssign for a description):
% Prob.LS.t;
% Prob.LS.weightType;
% Prob.LS.weightY;
% Prob.x_opt;
% Prob.f_opt;
%
% Prob.SolverQP  If set, changes the default solver used.
%
...
%          "set fields in otxProb", e.g. otxProb.SolverQP = 'lssol';
%
% OUTPUT:
%
...
% Copyright (c) 1999-2004 by Tomlab Optimization Inc., $Release: 4.2.0$
% Written July 29, 1999.  Last modified Feb 3, 2004.
%
%
...
if isempty(Prob.SolverQP)
   Prob.SolverQP = GetSolver('lls',n > 500,0);
end
...
% Convert ExitFlag to OPTIM TB 2.0
if ExitFlag==0
   ExitFlag=1;
   if PriLev > 0

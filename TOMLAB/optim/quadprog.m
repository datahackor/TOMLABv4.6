% quadprog is the TOMLAB equivalent to QUADPROG in Optimization TB 2.x
...
% Written July 3, 1999.   Last modified Dec 21, 2004.
%
...
if isempty(Prob.SolverQP)
   Prob.SolverQP = GetSolver('qp',n > 200,0);
...
% Convert ExitFlag to OPTIM TB 2.x and 3.x
switch ExitFlag
case 0 
     ExitFlag=1;
case 1 
...
case 4 
     ExitFlag=-4;
     fprintf('quadprog (%s): Illegal initial point x_0 found\n',Solver);
end

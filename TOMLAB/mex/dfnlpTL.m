...
if nargin < 1, error('dfnlpTL needs the Prob structure as input');return;end

global MAX_x MAX_c MAX_r ksNLP_x ksNLP_xJ % Max number of variables/constraints/resids to print

...
%            0 - Solution obtained
%            1 - Unbounded problem detected (f(x)<=fLow occured)
...
% -----------------------------------------------------------------------
%
% For a problem description, see bqpd.m
%
% -------------------------------------------------------------------------
%
...
% Written May 12, 2002.  Last modified Dec 22, 2004.
%
...
if nargin < 1, error('bqpdTL needs the Prob structure as input');return;end
...
switch Inform
   ...
   case 1
      Text = 'Unbounded problem detected (f(x)<=fLow occured)';
   case 2

...
%
% SNOPT creates a print file (print.dat) and a summary file (summary.dat).
%
% -------------------------------------------------------------------------
%
% Kenneth Holmstrom, Tomlab Optimization Inc, E-mail: hkh@tomlab.biz
% Copyright (c) 2000-2004 by Tomlab Optimization Inc., $Release: 4.6.0$
% Written July 4, 2000.   Last modified Dec 3, 2004.
%

function Result = snopt7TL(Prob)

if nargin < 1, error('snopt7TL needs the Prob structure as input');end
...
Result.Solver='snopt';
Result.SolverAlgorithm='MEX-interface to SNOPT 7.1-1 NLP code';
...
[hs, xs, pi, rc, Inform, nS, nInf, sInf, Obj, iwCount, gObj, fCon, gCon] = ...
     snopt7( A, bl, bu, nnCon, nnObj, nnJac, Prob, iObj, optPar, ...
            Warm, hs, xs, pi, nS, ...
...
switch(Inform)
  ...
  case  5, Text= 'the problem appears to be infeasible';             
  case  6, Text=    'infeasible linear constraints';                 
  case  7, Text=    'infeasible linear equalities';                  
  case  8, Text=    'nonlinear infeasibilities minimized';           
  case  9, Text=    'infeasibilities minimized';                     
  case 10, Text= 'the problem appears to be unbounded';              
  case 11, Text=    'unbounded objective';                           
  case 12, Text=    'constraint violation limit reached';            
  case 13, Text= 'resource limit error';                             
  case 14, Text=    'iteration limit reached';                       
  case 15, Text=    'major iteration limit reached';                 
  case 16, Text=    'the superbasics limit is too small';            
  case 17, Text= 'terminated after numerical difficulties';          
  case 18, Text=    'current point cannot be improved';              
  case 19, Text=    'singular basis';                                
  case 20, Text=    'cannot satisfy the general constraints';        
  case 21, Text=    'ill-conditioned null-space basis';              
  case 22, Text= 'error in the user-supplied functions';             
  case 23, Text=    'incorrect objective  derivatives';              
  case 24, Text=    'incorrect constraint derivatives';              
  case 25, Text=    'the QP Hessian is indefinite';                  
  case 26, Text= 'undefined user-supplied functions';                
  case 27, Text=    'undefined function at the first feasible point';
  case 28, Text=    'undefined function at the initial point';       
  case 29, Text=    'unable to proceed into undefined region';       
  case 30, Text= 'user requested termination';                       
  case 31, Text=    'terminated during function evaluation';         
  case 32, Text=    'terminated during constraint evaluation';       
  case 33, Text=    'terminated during objective evaluation';        
  case 34, Text=    'terminated from monitor routine';               
  case 35, Text= 'insufficient storage allocated';                   
  case 36, Text=    'work arrays must have at least 500 elements';   
  case 37, Text=    'not enough character storage';                  
  case 38, Text=    'not enough integer storage';                    
  case 39, Text=    'not enough real storage';                       
  case 40, Text= 'input arguments out of range';                     
  case 41, Text=    'invalid input argument';                        
  case 42, Text=    'basis file dimensions do not match this problem';
  case 43, Text=    'the QP Hessian is indefinite';                  
  case 44, Text= 'finished successfully';                            
  case 45, Text=    'OPTIONS file read';                             
  case 46, Text=    'Jacobian structure estimated';                  
  case 47, Text=    'MPS file read';                                 
  case 48, Text= 'errors while processing MPS data';                 
  case 49, Text=    'no MPS file specified';                         
  case 50, Text=    'problem-size estimates too small';              
  case 51, Text=    'fatal error in the MPS file';                   
  case 52, Text= 'errors while estimating Jacobian structure';       
  case 53, Text=    'cannot find Jacobian structure at given point'; 
  case 54, Text= 'errors while reading OPTIONS file';                
  case 55, Text=    'no OPTIONS file specified';                     
  case 56, Text=    'fatal error in the OPTIONS file';               
  case 57, Text= 'system error';                                     
  case 58, Text=    'wrong no of basic variables';
  case 59, Text=    'error in basis package';

...
% Written Nov 8, 2000.     Last modified Dec 22, 2004.
%
...
if nargin < 1, error('lseiTL needs the Prob structure as input');return;end
...
% Weight the problem according to Tomlab standard
...
elseif weightType==3
   ...
   % This dynamic weight option is not available in LSEI
   fprintf('Dynamic weight option, weightType 3, is not possible with LSEI\n');
   error('Illegal weightType 3 for LSEI')
end
...
[x_k, rNormE, rNormL, Inform, Cov, eqRank, rlsRank] = lsei ( ...
